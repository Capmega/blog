...
class BlogPost extends ResourceModel
{
   ...
   {
       return $this->hasOne('Capmega\Blog\Models\Blog', 'id', 'blog_id');
   }

   public function parent()
   {
       return $this->belongsTo('Capmega\Blog\Models\BlogPost', 'parent_id', 'id');
   }

   public function childs()
   {
       return $this->hasMany('Capmega\Blog\Models\BlogPost', 'parent_id', 'id')->where('status', self::STATUS_ACTIVE);
   }

   public function images()
   {
       return $this->hasMany('Capmega\Blog\Models\BlogImage', 'blog_post_id', 'id');
   }
   ...
   {
       return $this->hasMany('Capmega\Blog\Models\BlogKey', 'blog_post_id', 'id');
   }
