...
class Blog extends ResourceModel
{
    ...
    public function childs(){
        return $this->hasMany('Capmega\Blog\Models\Blog', 'parent_id', 'id')->where('status', self::STATUS_ACTIVE);
    }
    ...
    {
        return $this->belongsTo('Capmega\Blog\Models\Blog', 'parent_id', 'id');
    }

    public function translate()
    {
        return $this->hasOne('Capmega\Blog\Models\Blog', 'blog_id', 'id');
    }

    public function posts(){
        return $this->hasMany('Capmega\Blog\Models\BlogPost', 'blog_id', 'id')->where('status', self::STATUS_ACTIVE);
    }
