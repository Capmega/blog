<?php
namespace Capmega\Blog\Controllers;

use Illuminate\Http\Request;
use Capmega\Base\Controllers\ResourceController;
use Capmega\Blog\Models\{Blog, BlogImage};
use Capmega\Base\Helpers\Images;

class BlogPostController extends ResourceController
{
    protected $model       = 'Capmega\Blog\Models\BlogPost';
    ...
    public function store(Request $request)
    {
        ...
        $model = new $this->model();
        $model->status = \Capmega\Blog\Models\BlogPost::STATUS_ACTIVE;
